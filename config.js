...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'ī.am/ꪶfahriSlebewꫂ⁩⁩⁩' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '6287785175535' : process.env.NUMBER,
    MENTION: process.env.TAG_REPLY === undefined ? '6287785175535@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BC: process.env.BROADCAST_NAME === undefined ? '🥵FahriSlebew🥶⁩' : process.env.BROADCAST_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? '🥵Fahri-Slebew🥶' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/fahrifq_' : process.env.SOCIAL_MEDIA,
